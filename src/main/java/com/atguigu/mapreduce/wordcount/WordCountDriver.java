...
public class WordCountDriver {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        FileOutputFormat.setOutputPath(job, new Path("D:\\EnvironmentTools\\JetBrains\\IDEAWorkSpace\\HDFSClient\\src\\main\\java\\com\\atguigu\\mapreduce\\wordcount\\output1"));
